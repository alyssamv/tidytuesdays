...
ggsave("./2019/GlobalWaste_0521/pct_global_mismanaged_waste.png", width = 14, height = 8)
```
...
ggsave("./2019/GlobalWaste_0521/country_pct_mismanaged_boxplot.png", width = 10, height = 7)
```
