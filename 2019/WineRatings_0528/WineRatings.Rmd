...
ggplot(prices, aes(y = log(price), x = country, fill = "grey")) +
  geom_boxplot() +
  ...
  labs(
    ...
    subtitle = "The distribution of wine price by country is shown below in log-scale.\nNote how the majority of each country's price distribution falls below the global\nmedian, even in log-scale. This suggests highly skewed pricing, which is\nreflected in that out of 130k wines, only a handful cost more than\na few hundred dollars.",
